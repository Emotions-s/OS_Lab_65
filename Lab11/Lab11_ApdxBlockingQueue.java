...
class Lab11_ApdxBlockingQueue<E> {
    ...
    public void put(E value) throws InterruptedException {
        ...
        try {
            while (curSize == items.length) {
                System.out.println("Can't put: Full, waiting");
                notFull.await();
                System.out.println("Can put: Stop waiting");
            }
    ...
    public E take() throws InterruptedException {
        ...
        try {
            while (curSize == 0) {
                System.out.println("Can't take: Empty, waiting");
                notEmpty.await();
                System.out.println("Can take: Stop waiting");
            }
